...
public class Approver {
    ...
    public Approver(String first_name, String last_name, String email, String password) {
    ...
    public boolean createApprover() {
        String insertQuery = "INSERT INTO approvers (first_name, last_name, email, password) VALUES (?, ?, ?, ?)";
        try {
